...
public class BaseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		android.view.WindowManager.LayoutParams attributes = getWindow()
				.getAttributes();
	...
	public void setBrightness(View v) {
		...
		if (brightness != null && brightness.equals("0")) {// 夜间模式
			viewHolder.tv_title.setText(getResources().getString(
					R.string.darkness_title));
			viewHolder.btn_menu
					.setBackgroundResource(R.drawable.btn_menu_darkness);
			...
			viewHolder.btn_menu
					.setBackgroundResource(R.drawable.btn_menu_brightness);
			attributes.screenBrightness = Setting.KEY_DARKNESS;
	...
	protected void onStart() {
		super.onStart();
		registerReceiver(commonRecevier, new IntentFilter(
