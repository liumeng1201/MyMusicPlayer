...
public class ScanAdapter extends BaseAdapter {
	...
	public ScanAdapter(Context context, List<ScanBean> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.iv_scan_item_icon = ((ImageView) convertView
					.findViewById(R.id.iv_scan_item_icon));
			viewHolder.tv_scan_item_title = ((TextView) convertView
					.findViewById(R.id.tv_scan_item_title));
			viewHolder.cb_scan_item = ((CheckBox) convertView
					.findViewById(R.id.cb_scan_item));
			convertView.setTag(viewHolder);
		} else {
			viewHolder = (ViewHolder) convertView.getTag();
		}
		viewHolder.iv_scan_item_icon
				.setImageResource(R.drawable.directory_icon);
		viewHolder.tv_scan_item_title.setText(filePath);

		viewHolder.cb_scan_item
